...
const Header = () => {
  ...
  return (
    <Fragment>
    <div className={`page-header ${toggleIcon ? 'close_icon' : ''} `} style={{backgroundColor:"#0F1821",border: '1.5px solid rgb(37, 37, 37)', boxShadow: '0.5px 0.5px 0.5px 0.5px rgba(0, 0, 0, 0.6)'}}>
