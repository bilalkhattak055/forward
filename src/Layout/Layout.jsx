...
const AppLayout = ({ children, classNames, ...rest }) => {
  ...
  useEffect(() => {
    if (location.state?.showToast) {
      ...
      ShowDisclaimer("This Dashboard is intended for authorized personnel only. All data and information displayed are proprietary to Forward and are confidential. Any unauthorized access, distribution, or misuse of the information contained in this platform may result in legal consequences. The company does not guarantee the absolute accuracy of the data presented and users are advised to cross-check critical information. By using this platform, you agree to comply with Forward data security and privacy policies.")
