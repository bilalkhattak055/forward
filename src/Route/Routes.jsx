...
// import Reports from "../Components/Dashboards/Dashboard/reports/index";
...
export const routes = {
  ...
  'factory': [
    ...
    { path: `${process.env.PUBLIC_URL}/dashboard/default`, Component: <ComingSoonPage/> },
    ...
    { path: `${process.env.PUBLIC_URL}/pages`, Component: <LiveAnalyticsForward/> },
