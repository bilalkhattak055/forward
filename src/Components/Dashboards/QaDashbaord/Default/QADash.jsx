...
<AccuracyCard
                      ...
                      accuracy={accuracySectionData.aiAccuracy?.value}
                    />
                    <div className="d-flex flex-column justify-content-center align-items-center gap-2 ">
                      ...
                      <h4 className="mb-0  d-flex align-items-center">
                        ...
                        {accuracySectionData.aiAccuracy?.value < 80 ? (
                          <ArrowDown color="red" size={20} />
                        ) : isNaN(accuracySectionData.aiAccuracy?.value) ? 
                        <>
...
{!isNaN(accuracySectionData.aiAccuracy?.value) ? `${accuracySectionData.aiAccuracy?.value}%` : 'N/A'}
                      </h4>
