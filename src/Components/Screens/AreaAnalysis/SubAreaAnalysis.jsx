          ...
          {memberss.map((member, index) => {
            ...
            return (
              <div key={index} className="col" data-aos="fade-up" data-aos-delay={index * 100}>
                <div style={{ cursor: 'pointer' }} onClick={() => handleNavigate(member)} className="card h-100 shadow-sm d-flex flex-column">
