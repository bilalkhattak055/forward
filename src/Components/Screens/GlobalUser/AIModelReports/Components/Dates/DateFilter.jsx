...
export default function DateFilter({maxWeek,shiftNotShow, allarea, area, allData, shouldShowButton,style, selectedOption,selectArea, currentWeek,typeHeadChange,filters,handleDateDrop,handleInputChange, dateShow,monthShow,weeklyShow,customDate}) {
    const multiple = true
